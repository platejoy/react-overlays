...
function (_React$Component) {
  ...
  function Affix(props, context) {
    ...
    _this.onUpdate = function () {
      ...
      var scrollTop = (0, _scrollTop.default)((0, _ownerWindow.default)(_assertThisInitialized(_this)));
    ...
    _this.getPositionTopMax = function () {
      var documentHeight = (0, _getDocumentHeight.default)((0, _ownerDocument.default)(_assertThisInitialized(_this)));
      var height = (0, _height.default)(_reactDom.default.findDOMNode(_assertThisInitialized(_this)));
    ...
    _this.updateStateAtBottom = function () {
      ...
      var offsetParent = (0, _offsetParent.default)(_reactDom.default.findDOMNode(_assertThisInitialized(_this)));
