...
function (_React$Component) {
  ...
  function Affix(props, context) {
    ...
    _this.onUpdate = function () {
      ...
      var scrollTop = getScrollTop(ownerWindow(_assertThisInitialized(_this)));
    ...
    _this.getPositionTopMax = function () {
      var documentHeight = getDocumentHeight(ownerDocument(_assertThisInitialized(_this)));
      var height = getHeight(ReactDOM.findDOMNode(_assertThisInitialized(_this)));
    ...
    _this.updateStateAtBottom = function () {
      ...
      var offsetParent = getOffsetParent(ReactDOM.findDOMNode(_assertThisInitialized(_this)));
