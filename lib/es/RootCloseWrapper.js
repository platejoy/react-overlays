...
function (_React$Component) {
  ...
  function RootCloseWrapper(props, context) {
    ...
    _this.addEventListeners = function () {
      ...
      var doc = ownerDocument(_assertThisInitialized(_this)); // Use capture for this listener so it fires before React's listener, to
    ...
    _this.handleMouseCapture = function (e) {
      _this.preventMouseRootClose = isModifiedEvent(e) || !isLeftClickEvent(e) || contains(ReactDOM.findDOMNode(_assertThisInitialized(_this)), e.target);
    };
